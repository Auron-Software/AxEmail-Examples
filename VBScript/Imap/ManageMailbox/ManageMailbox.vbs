...
Wscript.Echo "Create, result: " & objImap.LastError & " (" & objImap.GetErrorDescription( objImap.LastError ) & ")"

objImap.Rename strNewMailbox, strNewMailbox & "_renamed"
Wscript.Echo "Rename, result: " & objImap.LastError & " (" & objImap.GetErrorDescription( objImap.LastError ) & ")"

objImap.Delete strNewMailbox & "_renamed"
Wscript.Echo "Delete, result: " & objImap.LastError & " (" & objImap.GetErrorDescription( objImap.LastError ) & ")"
