<%@ Page Language="vb" MasterPageFile="Layout.Master" AutoEventWireup="false" CodeBehind="frmpop3.aspx.vb" Inherits="VisualBasicDemo.frmpop3" %>

		<asp:Content runat="server" ContentPlaceHolderID="container">
            <h1>Auron Email Component - ASP .NET VB POP3</h1>
			<hr />
			<p>
