<%@ Page Language="C#" MasterPageFile="Layout.Master" AutoEventWireup="true" CodeBehind="frmimap.aspx.cs" Inherits="CSharpDemo.frmImap" %>

		<asp:Content runat="server" ContentPlaceHolderID="container">
            <h1>Auron Email Component - ASP .NET C# IMAP</h1>
			<hr />
			<p>
