...
MIDL_DEFINE_GUID(IID, IID_IOAuth2,0xFFB7E17F,0xEF95,0x437E,0xBB,0x93,0xEF,0x50,0x69,0x48,0xAD,0x18);
...
MIDL_DEFINE_GUID(CLSID, CLSID_OAuth2,0xFD456C7C,0x370E,0x4C9D,0x8E,0xF5,0x75,0x0A,0x13,0xAA,0xC1,0xED);
